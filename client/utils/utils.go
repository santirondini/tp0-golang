...
// os.Stdout representa la salida estandar (consola)
// mv es un escritor combinado que enviará cualquier mensaje de log tanto a consola como al archivo
// Ejemplo de uso: log.Println("Este es un mensaje de prueba")
